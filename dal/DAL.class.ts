    ...
    constructor(dalSettings:DALI.IDALSettings) {
        ...
        this.knex = knex({
            ...
            connection: {
                ...
                port: dalSettings.port || process.env.MAINDB_PORT || 5432,
                password : dalSettings.password || process.env.MAINDB_PASS ||'password',
                database : dalSettings.database || process.env.MAINDB_DBNAME ||'postgres',
                schema : dalSettings.schema || process.env.MAINDB_SCHEMA ||'reestrum',
